...
describe('Users Endpoints', () => {
    ...
    describe(`Unauthorized request`, () => {
        ...
        it(`responds 401 Unauthorized for GET /api/users/:user_id`, () => {
        ...
        it(`responds with 401 Unauthorized for PATCH /api/users/:user_id`, () => {
            const user = testUsers[1];
            return supertest(app)
    ...
    describe(`GET /api/users/:user_id`, () => {
        ...
        context(`Given an XSS attack user`, () => {
            ...
            it(`removes XSS attack content`, () => {
                return supertest(app)
                    .get(`/api/users/${maliciousUser.user_id}`)
                    .set('Authorization', `Bearer ${process.env.API_TOKEN}`)
                    .expect(200)
                    .expect(res => {
    ...
    describe(`DELETE /api/users/:user_id`, () => {
        ...
        context(`Given there are users`, () => {
            ...
            it(`responds with 204 and removes the user`, () => {
                const idToRemove = 1;
                const expectedUsers = testUsers.filter(u => u.user_id !== idToRemove);
